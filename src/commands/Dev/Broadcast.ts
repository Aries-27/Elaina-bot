...
export default class Command extends BaseCommand {
	...
	run = async (
		...
		const gifs = [
			"https://c.tenor.com/uRuAy_M2WVcAAAPo/kawaii-anemone.mp4",
			"https://c.tenor.com/1hMFQPm5GOwAAAPo/wataten-watashi-ni-tenshi-ga-maiorita.mp4",
			"https://c.tenor.com/pvqlOYattbgAAAPo/anime-watashinitenshigamaiorita.mp4",
			"https://c.tenor.com/IHqPSJgSmR4AAAPo/furious-down.mp4",
			"https://c.tenor.com/Mqc349Zmh94AAAPo/wataten-hana.mp4",
